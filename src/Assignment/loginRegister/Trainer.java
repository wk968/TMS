...
public class Trainer extends User {
    ...
    public Trainer(String profileID, String userName, int userAge, String userGender, String userEmail, String userContact, String userID) {
        super(profileID, userName, userAge, userGender, userEmail, userContact, userID);
        super.setTrainer(true);
    }
